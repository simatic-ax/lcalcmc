...
The function `MoveVelocityTime` calculates the time needed to reach the specified velocity from starting dynamics (velocity and acceleration at start). The dynamic values are taken into account (acceleration, deceleration, jerk).
...
| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `MoveVelocityTime` | `LCalcMC.Status` | Status of the function; WORD#16#0000: Calculation finished successfully <br/> WORD#16#8000 - WORD#16#FFFF: Error identification |
